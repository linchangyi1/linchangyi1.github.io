...
<div class="brder-system">
    ...
    <div class="font-style font-size-context margin-style border-edge">
        ...
        <div class="flex-row video-height justify-center">
            ...
            <video src="./static/video/dart_vedio/Decelerate1.mp4" autoplay loop controls muted></video>
        </div>
        <div class="margin-style">
    ...
    <div class="font-style font-size-context margin-style border-edge">
        ...
        <p style="text-align: center;">
            <video height="250px" src="./static/video/dart_vedio/Reloading0.mp4" autoplay loop controls muted></video>
        </p>
        <div class="margin-style">
...
<div class="brder-system margin-top">
    ...
    <div class="font-style font-size-context margin-style border-edge">
        ...
        <p style="text-align: center;">
            <video height="250px" src="./static/video/dart_vedio/UAV0.mp4" autoplay loop controls muted></video>
        </p>
        <div class="margin-style">
            <p>Banded for its excessive flexibility.</p>
        </div>
